...
CMakeFiles/missing-phys-val-all:
	...
	/usr/local/Cellar/cmake/3.11.1/bin/cmake -E echo "NOTE: You called the target \`check-all\`, but ran cmake with \`-DGMX_PHYSICAL_VALIDATION=OFF\`. The physical validation tests are therefore unavailable, and this target is equivalent to a simple \`make check\`."
